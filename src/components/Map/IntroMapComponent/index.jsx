    ...
    <Box
      ...
      <Box
        ...
        <StepStage
          ...
          stepTime={parseInt(userData.userStepTime.fase03.time)}
          stepDispo={0}
          stepStop={userData.stepStop.stepStop}
        />
        <StepStage
          ...
          stepTime={parseInt(userData.userStepTime.fase04.time)}
          stepDispo={0}
          stepStop={userData.stepStop.stepStop}
        />
      </Box>
      <Box
        ...
        <StepStage
          ...
          stepTime={parseInt(userData.userStepTime.fase05.time)}
          stepDispo={0}
          stepStop={userData.stepStop.stepStop}
        />
        <StepStage
          ...
          stepTime={parseInt(userData.userStepTime.fase06.time)}
          stepDispo={0}
          stepStop={userData.stepStop.stepStop}
        />
        <StepStage
          ...
          stepTime={parseInt(userData.userStepTime.fase07.time)}
          stepDispo={0}
          stepStop={userData.stepStop.stepStop}
        />
      </Box>
